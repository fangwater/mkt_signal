...
PARAM_COMMENTS: Dict[str, str] = {
    ...
    "enable_volatility_limit": "是否启用基于 inline vol 阈值的开仓 gate（普通 intra: vol <= threshold 才允许开仓；okex-intra: vol > threshold 才允许开仓；intra 默认 false）",
    "open_volatility_limit": "开仓 vol gate 使用的 rolling 分位数（0-100，默认 70；okex-intra 比较方向相反）",
