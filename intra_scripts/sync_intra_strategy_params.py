...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Sync intra/cta strategy params to Redis")
...
PARAM_COMMENTS: Dict[str, str] = {
    ...
    "taker_decsion_nn_model_open_cancel_short_score": "nn_model 滤波结果高于该固定值时撤掉 open short",
...
PARAM_PRINT_ORDER = [
    ...
    "taker_decsion_nn_model_kalman_q",
    "taker_decsion_nn_model_keep_long_score",
    "taker_decsion_nn_model_keep_short_score",
    "taker_decsion_nn_model_open_cancel_long_score",
    "taker_decsion_nn_model_open_cancel_short_score",
...
def main() -> int:
    ...
    print(f"🔄 同步 {args.namespace} 策略参数: {key}")
