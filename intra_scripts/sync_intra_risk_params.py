...
RISK_PARAMS = {
    ...
    "max_leverage": "5.0",
    "unimmr_trigger_line": "1.5",
    "unimmr_recover_line": "1.6",
...
PARAM_COMMENTS: Dict[str, str] = {
    ...
    "max_leverage": "最大杠杆倍数",
    "unimmr_trigger_line": "UniMMR 全局只减仓锁定线：mr < trigger 时禁止 ArbOpen 增仓；Binance 标准账户无效（>=1.5 且 < recover）",
    "unimmr_recover_line": "UniMMR 全局只减仓恢复线：mr > recover 时恢复 ArbOpen 增仓；Binance 标准账户无效",
