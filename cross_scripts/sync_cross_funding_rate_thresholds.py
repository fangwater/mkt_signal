...
"""
将 cross（跨所）资金费率阈值同步到 Redis 并打印。

写入 Redis Hash:
  `cross_funding_rate_thresholds_{open_venue}_{hedge_venue}`
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Sync cross funding rate thresholds to Redis")
...
def main() -> int:
    ...
    key = f"cross_funding_rate_thresholds_{open_venue}_{hedge_venue}"
