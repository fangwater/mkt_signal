...
pub fn publish_mm_uniform_new_order(
...
pub fn publish_mm_uniform_terminal_order(
    order_update: &dyn OrderUpdate,
    order: &Order,
    prev_cumulative_filled_qty: f64,
    ctx: &UniformPublishCtx,
...
pub fn publish_mm_uniform_trade_order(
...
pub fn publish_mm_uniform_trade_order_from_order_update(
    order_update: &dyn OrderUpdate,
    order: &Order,
    prev_cumulative_filled_qty: f64,
    ctx: &UniformPublishCtx,
