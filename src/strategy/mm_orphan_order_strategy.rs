...
impl Strategy for MmOrphanOrderStrategy {
    ...
    fn apply_order_update(&mut self, update: &dyn OrderUpdate) {
        ...
        let _ = self
            .orders
            .apply_order_update(MM_ORPHAN_ROLE, self.strategy_id, update, 0.0);
    }
    ...
    fn apply_trade_update(&mut self, trade: &dyn TradeUpdate) {
        ...
        let _ = self
            .orders
            .apply_trade_update(MM_ORPHAN_ROLE, self.strategy_id, trade, 0.0);
    }

    fn handle_period_clock(&mut self, _current_tp: i64) {
        self.orders
            .handle_period_clock(MM_ORPHAN_ROLE, self.strategy_id, 0.0, false);
    }
