...
pub enum TradeResponseType {
    ...
    BinanceCancelAllUMOrders = 3005,  // 币安UM合约撤销全部订单
    BinanceCancelUMConditionalOrder = 3006,  // 币安UM条件单撤单
    BinanceCancelAllUMConditionalOrders = 3007,  // 币安UM条件单撤销全部订单
    BinanceCancelMarginOrder = 3008,  // 币安杠杆账户撤单
    BinanceModifyUMOrder = 3009,  // 币安UM合约修改订单
    BinanceQueryUMOrder = 3010,  // 币安UM合约查询订单
    BinanceQueryUMOpenOrder = 3011,  // 币安UM合约查询当前挂单
    ErrorResponse = 3999,
}
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelAllUMOrdersResponseBody {
    pub code: i32,
    pub msg_length: u32,
    pub msg: String,
}

impl BinanceCancelAllUMOrdersResponseBody {
    pub fn to_bytes(&self) -> Bytes {
        let total_size = 4 + 4 + self.msg_length as usize;
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelAllUMOrdersResponse {
    pub header: TradeResponseHeader,
    pub body: BinanceCancelAllUMOrdersResponseBody,
}

impl BinanceCancelAllUMOrdersResponse {
    pub fn create(
        local_recv_time: i64,
        client_order_id: i64,
        code: i32,
        ...
        let body = BinanceCancelAllUMOrdersResponseBody {
            code,
            msg_length: msg.len() as u32,
            msg,
        };
        ...
        let header = TradeResponseHeader {
            msg_type: TradeResponseType::BinanceCancelAllUMOrders,
            local_recv_time,
            client_order_id,
            exchange: Exchange::BinanceFutures as u32,
            body_length: body_bytes.len() as u32,
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelUMConditionalOrderResponseBody {
    pub strategy_id: i64,
    pub book_time: i64,
    pub update_time: i64,
    pub good_till_date: i64,
...
impl BinanceCancelUMConditionalOrderResponseBody {
    pub fn to_bytes(&self) -> Bytes {
        let total_size = 8 + 8 + 8 + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4
            + self.strategy_type_length as usize
            + self.strategy_status_length as usize
            + self.symbol_length as usize
            + self.side_length as usize
            + self.position_side_length as usize
            + self.time_in_force_length as usize
            + self.working_type_length as usize
            + self.self_trade_prevention_mode_length as usize
            + self.price_match_length as usize
            + 8 * 5 + 1 + 1 + 6;
        ...
        buf.put_u32_le(self.position_side_length);
        buf.put_u32_le(self.time_in_force_length);
        buf.put_u32_le(self.working_type_length);
        buf.put_u32_le(self.self_trade_prevention_mode_length);
        buf.put_u32_le(self.price_match_length);
        buf.put(&self.padding[..]);
        ...
        buf.put(self.position_side.as_bytes());
        buf.put(self.time_in_force.as_bytes());
        buf.put(self.working_type.as_bytes());
        buf.put(self.self_trade_prevention_mode.as_bytes());
        buf.put(self.price_match.as_bytes());
        ...
        buf.put_f64_le(self.price);
        buf.put_f64_le(self.stop_price);
        buf.put_f64_le(self.activate_price);
        buf.put_f64_le(self.price_rate);
        buf.put_u8(if self.reduce_only { 1 } else { 0 });
        buf.put_u8(if self.price_protect { 1 } else { 0 });
        buf.put(&self.padding2[..]);
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelUMConditionalOrderResponse {
    pub header: TradeResponseHeader,
    pub body: BinanceCancelUMConditionalOrderResponseBody,
}

impl BinanceCancelUMConditionalOrderResponse {
    pub fn create(
        local_recv_time: i64,
        client_order_id: i64,
        strategy_id: i64,
        ...
        let body = BinanceCancelUMConditionalOrderResponseBody {
            strategy_id,
            book_time,
            update_time,
            good_till_date,
            ...
            position_side_length: position_side.len() as u32,
            time_in_force_length: time_in_force.len() as u32,
            working_type_length: working_type.len() as u32,
            self_trade_prevention_mode_length: self_trade_prevention_mode.len() as u32,
            price_match_length: price_match.len() as u32,
            padding: [0u8; 4],
            strategy_type,
        ...
        let header = TradeResponseHeader {
            msg_type: TradeResponseType::BinanceCancelUMConditionalOrder,
            local_recv_time,
            client_order_id,
            exchange: Exchange::BinanceFutures as u32,
            body_length: body_bytes.len() as u32,
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelAllUMConditionalOrdersResponseBody {
    pub code_length: u32,
    pub msg_length: u32,
    pub code: String,
    pub msg: String,
...
impl BinanceCancelAllUMConditionalOrdersResponseBody {
    pub fn to_bytes(&self) -> Bytes {
        let total_size = 4 + 4 + self.code_length as usize + self.msg_length as usize;

        let mut buf = BytesMut::with_capacity(total_size);

        buf.put_u32_le(self.code_length);
        buf.put_u32_le(self.msg_length);
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelAllUMConditionalOrdersResponse {
    pub header: TradeResponseHeader,
    pub body: BinanceCancelAllUMConditionalOrdersResponseBody,
}

impl BinanceCancelAllUMConditionalOrdersResponse {
    pub fn create(
        local_recv_time: i64,
        client_order_id: i64,
        code: String,
        ...
        let body = BinanceCancelAllUMConditionalOrdersResponseBody {
        ...
        let header = TradeResponseHeader {
            msg_type: TradeResponseType::BinanceCancelAllUMConditionalOrders,
            local_recv_time,
            client_order_id,
            exchange: Exchange::BinanceFutures as u32,
            body_length: body_bytes.len() as u32,
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelMarginOrderResponseBody {
    pub order_id: i64,
    pub symbol_length: u32,
    pub status_length: u32,
    pub order_type_length: u32,
...
impl BinanceCancelMarginOrderResponseBody {
    pub fn to_bytes(&self) -> Bytes {
        let total_size = 8 + 4 + 4 + 4 + 4 + 4 + 4
            + self.symbol_length as usize
            + self.status_length as usize
            + self.order_type_length as usize
            + self.time_in_force_length as usize
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceCancelMarginOrderResponse {
    pub header: TradeResponseHeader,
    pub body: BinanceCancelMarginOrderResponseBody,
}

impl BinanceCancelMarginOrderResponse {
    pub fn create(
        local_recv_time: i64,
        client_order_id: i64,
        symbol: String,
        ...
        let body = BinanceCancelMarginOrderResponseBody {
            order_id,
            symbol_length: symbol.len() as u32,
            status_length: status.len() as u32,
            order_type_length: order_type.len() as u32,
        ...
        let header = TradeResponseHeader {
            msg_type: TradeResponseType::BinanceCancelMarginOrder,
            local_recv_time,
            client_order_id,
            exchange: Exchange::Binance as u32,
            body_length: body_bytes.len() as u32,
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceModifyUMOrderResponseBody {
    pub order_id: i64,
    pub update_time: i64,
    pub good_till_date: i64,
    pub symbol_length: u32,
    pub orig_type_length: u32,
    pub symbol: String,
...
impl BinanceModifyUMOrderResponseBody {
    pub fn to_bytes(&self) -> Bytes {
        let total_size = 8 + 8 + 8 + 4 + 4
            + self.symbol_length as usize
            + self.orig_type_length as usize
            + 1 + 1 + 1 + 5
            + 8 * 6
            + 4 + 4 + 4 + 4 + 4 + 4
            + self.order_type_length as usize
        ...
        buf.put_i64_le(self.good_till_date);
        buf.put_u32_le(self.symbol_length);
        buf.put_u32_le(self.orig_type_length);
        buf.put(self.symbol.as_bytes());
        buf.put(self.orig_type.as_bytes());
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceModifyUMOrderResponse {
    pub header: TradeResponseHeader,
    pub body: BinanceModifyUMOrderResponseBody,
}

impl BinanceModifyUMOrderResponse {
    pub fn create(
        local_recv_time: i64,
        client_order_id: i64,
        symbol: String,
        ...
        let body = BinanceModifyUMOrderResponseBody {
            order_id,
            update_time,
            good_till_date,
            symbol_length: symbol.len() as u32,
            orig_type_length: orig_type.len() as u32,
            symbol,
            orig_type,
            side,
            position_side,
        ...
        let header = TradeResponseHeader {
            msg_type: TradeResponseType::BinanceModifyUMOrder,
            local_recv_time,
            client_order_id,
            exchange: Exchange::BinanceFutures as u32,
            body_length: body_bytes.len() as u32,
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceQueryUMOrderResponseBody {
    pub order_id: i64,
    pub time: i64,
    pub update_time: i64,
    pub good_till_date: i64,
...
impl BinanceQueryUMOrderResponseBody {
    pub fn to_bytes(&self) -> Bytes {
        let total_size = 8 + 8 + 8 + 8 + 4 + 4
            + self.symbol_length as usize
            + self.orig_type_length as usize
            + 1 + 1 + 1 + 5
            + 8 * 5
...
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceQueryUMOrderResponse {
    pub header: TradeResponseHeader,
    pub body: BinanceQueryUMOrderResponseBody,
}

impl BinanceQueryUMOrderResponse {
    pub fn create(
        local_recv_time: i64,
        client_order_id: i64,
        symbol: String,
        ...
        let body = BinanceQueryUMOrderResponseBody {
            order_id,
            time,
            update_time,
            good_till_date,
        ...
        let header = TradeResponseHeader {
            msg_type: TradeResponseType::BinanceQueryUMOrder,
            local_recv_time,
            client_order_id,
            exchange: Exchange::BinanceFutures as u32,
            body_length: body_bytes.len() as u32,
...
// 币安UM合约查询当前挂单响应体（与查询订单响应体相同）
pub type BinanceQueryUMOpenOrderResponseBody = BinanceQueryUMOrderResponseBody;

// 币安UM合约查询当前挂单响应
#[repr(C, align(8))]
#[derive(Debug, Clone)]
pub struct BinanceQueryUMOpenOrderResponse {
    pub header: TradeResponseHeader,
    pub body: BinanceQueryUMOpenOrderResponseBody,
}

impl BinanceQueryUMOpenOrderResponse {
    pub fn create(
        local_recv_time: i64,
        client_order_id: i64,
        symbol: String,
        ...
        let body = BinanceQueryUMOpenOrderResponseBody {
            order_id,
            time,
            update_time,
            good_till_date,
        ...
        let header = TradeResponseHeader {
            msg_type: TradeResponseType::BinanceQueryUMOpenOrder,
            local_recv_time,
            client_order_id,
            exchange: Exchange::BinanceFutures as u32,
            body_length: body_bytes.len() as u32,
