...
impl LimitsCfg {
    pub fn account_limit(&self) -> u32 { self.account_per_min.unwrap_or(1200) }
    pub fn ip_weight_limit(&self) -> u32 { self.ip_weight_per_min.unwrap_or(6000) }
    pub fn warn_ratio(&self) -> f32 { self.warn_ratio.unwrap_or(0.8) }
    pub fn cooldown_429(&self) -> u64 { self.cooldown_ms_429.unwrap_or(60_000) }
    pub fn ban_backoff_418(&self) -> u64 { self.ban_backoff_ms_418.unwrap_or(120_000) }
}
