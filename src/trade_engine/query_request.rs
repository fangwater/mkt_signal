...
pub enum QueryRequestType {
    ...
    BinancePmUsdtFreeSnapshot = 6106,
    BinancePmUsdtMaxBorrowable = 6107,
...
impl TryFrom<u32> for QueryRequestType {
    ...
    fn try_from(v: u32) -> Result<Self, Self::Error> {
        match v {
            ...
            6106 => Ok(QueryRequestType::BinancePmUsdtFreeSnapshot),
            6107 => Ok(QueryRequestType::BinancePmUsdtMaxBorrowable),
