...
use crate::{ExecutionType, OrderStatus, TimeInForce, TradingVenue};
...
fn map_trading_venue(code: u8) -> TradingVenue {
    match code {
        BybitBasicOrderMsg::VENUE_FUTURES => TradingVenue::BybitFutures,
        _ => TradingVenue::BybitMargin,
    }
}

impl OrderUpdate for BybitBasicOrderMsg {
...
impl TradeUpdate for BybitBasicOrderMsg {
    fn event_time(&self) -> i64 {
        self.event_time.saturating_mul(1_000)
    }
