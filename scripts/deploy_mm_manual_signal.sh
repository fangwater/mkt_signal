...
usage() {
  cat <<'USAGE'
Usage:
  scripts/deploy_mm_manual_signal.sh [trade|test] --exchange <binance|okex|gate|bybit|bitget> [--env-suffix <suffix>] [--env-name <exchange>_mm_<suffix>] [--scripts-only|--bin-only]
