...
compact = {
    ...
    "execution": {
        ...
        "factor_exit_quantile_long": execution["factor_exit_quantile_long"],
        "factor_exit_quantile_short": execution["factor_exit_quantile_short"],
        "trailing_stop_trigger_step": execution["trailing_stop_trigger_step"],
        "trailing_stop_move_step": execution["trailing_stop_move_step"],
    },
}
