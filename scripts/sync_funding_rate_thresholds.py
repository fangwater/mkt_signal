...
FUNDING_RATE_THRESHOLDS = {
    # 8小时周期（币安默认）
    "8h_forward_open": "0.0008",       # 正套开仓：预测费率 > 0.08% 时开仓
    "8h_forward_close": "-0.0008",     # 正套平仓：预测费率 < -0.08% 时平仓
    "8h_backward_open": "-0.0005",     # 反套开仓：预测费率 < -0.05% 时开仓
    "8h_backward_close": "0.0005",     # 反套平仓：预测费率 > 0.05% 时平仓

    # 4小时周期（部分交易所）
    "4h_forward_open": "0.00004",      # 正套开仓：预测费率 > 0.004% 时开仓
    "4h_forward_close": "-0.00004",    # 正套平仓：预测费率 < -0.004% 时平仓
    "4h_backward_open": "-0.00005",    # 反套开仓：预测费率 < -0.005% 时开仓
    "4h_backward_close": "0.00005",    # 反套平仓：预测费率 > 0.005% 时平仓
}
