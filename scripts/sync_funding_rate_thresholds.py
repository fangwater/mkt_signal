...
FUNDING_RATE_THRESHOLDS = {
    ...
    "8h_forward_close": "-0.0004",     # 正套平仓：预测费率 < -0.008% 时平仓
    "8h_backward_open": "-0.00008",     # 反套开仓：预测费率 < -0.005% 时开仓
    "8h_backward_close": "0.0004",     # 反套平仓：预测费率 > 0.005% 时平仓

    # 4小时周期（部分交易所）
    "4h_forward_open": "0.00004",      # 正套开仓：预测费率 > 0.004% 时开仓
    "4h_forward_close": "-0.0004",    # 正套平仓：预测费率 < -0.004% 时平仓
    "4h_backward_open": "-0.00004",    # 反套开仓：预测费率 < -0.005% 时开仓
    "4h_backward_close": "0.0004",    # 反套平仓：预测费率 > 0.005% 时平仓
}
