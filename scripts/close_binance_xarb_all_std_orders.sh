...
usage() {
  cat <<'EOF'
用法:
  scripts/close_binance_xarb_all_std_orders.sh --env-name binance-binance-xarb-trade01 [--execute] [--symbol BTCUSDT]
  scripts/close_binance_xarb_all_std_orders.sh binance-binance-xarb-trade01 --execute
