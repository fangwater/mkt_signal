#!/usr/bin/env python3
"""Fetch Gate.io futures account snapshot (USDT/coin-settled).

Usage:
  export GATE_API_KEY="your_api_key"
  export GATE_API_SECRET="your_api_secret"
  python scripts/gate_futures_account.py --settle usdt
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Gate.io futures account snapshot.")
...
def main() -> None:
    ...
    url_path = f"/futures/{args.settle}/accounts"
    query_param = ""
    body = ""
