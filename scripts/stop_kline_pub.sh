...
usage() {
  cat <<'EOF'
Usage:
  stop_kline_pub.sh [--namespace <ns>] (--exchange <exchange> | <exchange> | <venue...>)

Examples:
  ./scripts/stop_kline_pub.sh --exchange binance
  ./scripts/stop_kline_pub.sh okex
  ./scripts/stop_kline_pub.sh binance-futures
  ./scripts/stop_kline_pub.sh binance-futures binance-margin
