...
示例：
  python scripts/sync_mm_risk_params.py --open-venue binance-futures --hedge-venue binance-futures
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Sync MM pre-trade risk params to Redis")
