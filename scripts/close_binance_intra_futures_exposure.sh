...
usage() {
  cat <<'EOF'
用法:
  scripts/close_binance_intra_futures_exposure.sh --env-name binance-intra-trade [--execute] [--min-net-usdt 10]
  scripts/close_binance_intra_futures_exposure.sh binance-intra-trade --execute

说明:
  - 同所期现 Binance STANDARD 账户的期货平敞口
