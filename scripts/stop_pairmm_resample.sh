...
usage() {
  cat <<'EOF'
Usage:
  stop_pairmm_resample.sh [--namespace <ns>] (--exchange <exchange> | <exchange> | <venue...>)

Examples:
  ./scripts/stop_pairmm_resample.sh --exchange binance
  ./scripts/stop_pairmm_resample.sh okex
  ./scripts/stop_pairmm_resample.sh binance-futures
  ./scripts/stop_pairmm_resample.sh binance-futures binance-margin
