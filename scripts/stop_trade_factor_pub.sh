...
usage() {
  cat <<'USAGE'
Usage:
  stop_trade_factor_pub.sh [--namespace <ns>] (--exchange <exchange> | <exchange> | <venue...>)

Examples:
  ./scripts/stop_trade_factor_pub.sh --exchange binance
  ./scripts/stop_trade_factor_pub.sh okex
  ./scripts/stop_trade_factor_pub.sh binance-futures
  ./scripts/stop_trade_factor_pub.sh binance-futures binance-margin
